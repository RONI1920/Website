                                ...
                                <div class="col-lg-12 col-xl- 12">
                                    <div class="card border mb-0">
                                        ...
                                        <form action="{{ route('update.usability') }}" method="POST"
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <label class="form-label">Title Usability</label>
                                                    <input class="form-control" type="text" name="title"
                                                        value="{{ $usability->title }}">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">Link Usability</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="description" class="form-control" rows="3">{{ $usability->description }}</textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">Image Usability</label>
