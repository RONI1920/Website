...
<head>
    ...
    <title>Easy Solution & Technology</title>

    <link rel="shortcut icon" href="{{ asset('fronted/assets/images/favicon.ico') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('fronted/assets/images/favicon.ico') }}" type="image/x-icon">
    <!--- End favicon-->
