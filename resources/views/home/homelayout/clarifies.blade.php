        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="lonyo-content-thumb" data-aos="fade-up" data-aos-duration="700">
                    <img src="{{ asset($clarifi->image) }}" alt="Clarifi Thumbnail">
                </div>
            </div>
                    ...
                    <div class="lonyo-faq-wrap1 mt-50">
                        ...
                        <div class="lonyo-faq-item open" data-aos="fade-up" data-aos-duration="500">
                            ...
                            <div class="lonyo-faq-body">
                                <p>Automatically and syncs with bank accounts and credit cards to
                                    provide instant updates on spending, helping users stay aware of
                                    their all daily transactions.</p>
                            </div>
                        </div>
